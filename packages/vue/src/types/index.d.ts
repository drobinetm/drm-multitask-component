...
export type MultiTabCloseGuard = (tab: MultiTabItem, context: MultiTabCloseContext) => MultiTabCloseGuardResult;
...
export type CreateScopedStorageKey = (baseKey: string, ...segments: Array<string | number | null | undefined>) => string;
